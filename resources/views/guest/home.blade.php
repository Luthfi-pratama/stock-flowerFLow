          ...
          <div class="off-canvas-inner">
            ...
            <div class="offcanvas-widget-area">
              ...
              <p class="desc-content">
                Kami menyediakan berbagai buang yang indah <br />
                Dengan harga yang bersaing dengan toko yang lain <br />
                Bunga yang masih segar dan tahan lama.
              </p>
              <div class="switcher">
                <div class="language">
        ...
        <div class="swiper-wrapper">
          <div
            ...
            <div class="intro11-content text-left">
              ...
              <p class="desc-content">
                Kami menydiakan berbagai bunga yang indah
              </p>
              <a
          ...
          <div
            class="intro11-section swiper-slide slide-2 slide-bg-1 bg-position">
            <!-- Intro Content Start -->
            <div class="intro11-content text-left">
                ...
                <div class="single-item swiper-slide">
                  ...
                  <div class="single-product position-relative mb-30">
                    ...
                    <div class="product-content">
                      <div class="product-title">
                        <h4 class="title-2">
                          <a href="product-details.html">Bunga tangkai</a>
                        </h4>
                      </div>
                  ...
                  <div class="single-product position-relative mb-30">
                    ...
                    <div class="product-content">
                      <div class="product-title">
                        <h4 class="title-2">
                          <a href="product-details.html">Bunga melati</a>
                        </h4>
                      </div>
                      <div class="product-rating">
                        <i class="fa fa-star"></i>
                ...
                <div class="single-item swiper-slide">
                  ...
                  <div class="single-product position-relative mb-30">
                    ...
                    <div class="product-content">
                      <div class="product-title">
                        <h4 class="title-2">
                          <a href="product-details.html">Buket mawar putih</a>
                        </h4>
                      </div>
                      <div class="product-rating">
                        <i class="fa fa-star"></i>
                ...
                <div class="single-item swiper-slide">
                  ...
                  <div class="single-product position-relative mb-30">
                    ...
                    <div class="product-content">
                      <div class="product-title">
                        <h4 class="title-2">
                          <a href="product-details.html">Kemuliaan Salju</a>
                        </h4>
                      </div>
                      <div class="product-rating">
                        <i class="fa fa-star"></i>
                  ...
                  <div class="single-product position-relative mb-30">
                    ...
                    <div class="product-content">
                      <div class="product-title">
                        <h4 class="title-2">
                          <a href="product-details.html">Bunga bucket</a>
                        </h4>
                      </div>
                      <div class="product-rating">
                        <i class="fa fa-star"></i>
                ...
                <div class="single-item swiper-slide">
                  ...
                  <div class="single-product position-relative mb-30">
                    ...
                    <div class="product-content">
                      <div class="product-title">
                        <h4 class="title-2">
                          <a href="product-details.html">Mutiara Abadi</a>
                        </h4>
                      </div>
                      <div class="product-rating">
                        <i class="fa fa-star"></i>
                  ...
                  <div class="single-product position-relative mb-30">
                    ...
                    <div class="product-content">
                      <div class="product-title">
                        <h4 class="title-2">
                          <a href="product-details.html"
                            >Bunga tongkat merah muda aster</a
                          >
                        </h4>
                      </div>
                      <div class="product-rating">
                ...
                <div class="single-item swiper-slide">
                  ...
                  <div class="single-product position-relative mb-30">
                    ...
                    <div class="product-content">
                      <div class="product-title">
                        <h4 class="title-2">
                          <a href="product-details.html">Buang putih</a>
                        </h4>
                      </div>
                      <div class="product-rating">
                        <i class="fa fa-star"></i>
                  ...
                  <div class="single-product position-relative mb-30">
                    ...
                    <div class="product-content">
                      <div class="product-title">
                        <h4 class="title-2">
                          <a href="product-details.html">Tongkat bunga merah</a>
                        </h4>
                      </div>
                      <div class="product-rating">
                        <i class="fa fa-star"></i>
    ...
    <div class="product-countdown-area mt-text-3">
      <div class="container custom-area">
        ...
        <div class="row">
          ...
          <div class="col-12 col-custom">
            <div class="countdown-area">
              <div
                class="countdown-wrapper d-flex justify-content-center"
        ...
        <div class="row product-row">
          <div class="col-12 col-custom">
            <div
              class="item-carousel-2 swiper-container anime-element-multi product-area">
              <div class="swiper-wrapper">
                <div class="single-item swiper-slide">
                  <!--Single Product Start-->
                  <div class="single-product position-relative mb-30">
                ...
                <div class="single-item swiper-slide">
                  ...
                  <div class="single-product position-relative mb-30">
                    ...
                    <div class="product-content">
                      <div class="product-title">
                        <h4 class="title-2">
                          <a href="product-details.html">Bunga mekar</a>
                        </h4>
                      </div>
                      <div class="product-rating">
                        <i class="fa fa-star"></i>
        ...
        <div class="row">
          <div class="col-lg-8 ms-auto me-auto">
            <div class="history-area-content pb-0 mb-0 border-0 text-center">
              <p>
                <strong
                  >Kami berpengalaman dalam membuat buang yang indah</strong
                >
              </p>
              ...
              <div class="single-item swiper-slide">
                ...
                <div class="single-testimonial text-center">
                  ...
                  <div class="testimonial-content">
                    <p>
                      Orang-orang ini benar-benar luar biasa. Tema Sempurna dan
                      yang terbaik dari semuanya sehingga Anda memiliki banyak
                      pilihan untuk dipilih! Tim Dukungan Terbaik yang pernah
                      ada! Sangat cepat merespon! Terima kasih banyak! Saya
                      sangat merekomendasikan tema ini dan orang-orang ini!
                    </p>
                ...
                <div class="single-testimonial text-center">
                  ...
                  <div class="testimonial-content">
                    <p>
                      ...
                      pilihan untuk dipilih! Tim Dukungan Terbaik yang pernah
                      ada! Sangat cepat merespon! Terima kasih banyak! Saya
                      sangat merekomendasikan tema ini dan orang-orang inie!
                    </p>
                    <div class="testimonial-author">
          ...
          <div class="col-md-6 col-custom">
            <div class="section-title text-left mb-35">
              ...
              <p class="desc-content mb-0">
                Masukkan Alamat Email Anda Untuk Milis Kami Agar Selalu Update
                Diri Anda
              </p>
            </div>
          </div>
            ...
            <div class="blog-lst">
              <div class="single-blog">
                ...
                <div class="blog-content">
                  <div class="blog-text">
                    <h4>
                      <a href="blog-details-fullwidth.html">Koleksi Baru</a>
                    </h4>
                    <div class="blog-post-info">
                      <span><a href="#">By admin</a></span>
                      <span>Maret 03, 2023</span>
            ...
            <div class="blog-lst">
              <div class="single-blog">
                ...
                <div class="blog-content">
                  <div class="blog-text">
                    <h4>
                      <a href="blog-details-fullwidth.html">Posting blog </a>
                    </h4>
                    <div class="blog-post-info">
                      <span><a href="#">By admin</a></span>
                      <span>Maret 03, 2023</span>
          ...
          <div class="row">
            <div class="col-12 col-sm-12 col-md-12 col-lg-3 col-custom">
              <div class="single-footer-widget m-0">
                ...
                <p class="desc-content">
                  Kami sangat senang dapat melayani anda.
                </p>
            ...
            <div class="col-12 col-sm-6 col-md-6 col-lg-3 col-custom">
              <div class="single-footer-widget">
                ...
                <div class="widget-body">
                  <address>
                    Jakarta.<br />Phone: 0814 567 890<br />Email:
                    https://tokobunga@gmail.com
                  </address>
                </div>
              </div>
            </div>
                ...
                <div class="col-md-6 col-custom">
                  <div class="modal-product">
                    <div class="product-content">
                      ...
                      <p class="desc-content">
                        Kami sangat senang jika anda dapat berbelanja di koto
                        kami.
                      </p>
